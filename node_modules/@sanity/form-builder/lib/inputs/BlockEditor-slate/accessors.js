...
var _randomKey = require('../ArrayInput/randomKey');
...
exports.NodeAccessor = NodeAccessor; // Represents a span of characters with identical marks. In Sanity terms this accessor corresponds to a single
...
exports.TextSpanAccessor = TextSpanAccessor; // Represents the spans of a paragraph. The impedance mismatch between the slate native representation and the sanity representation
...
class SpansAccessor {
  static createFromSlateParagraph(paragraph) {
    const spans = (0, _flatten3.default)(paragraph.nodes.toArray().map(childNode => {
...
exports.SpansAccessor = SpansAccessor; // Wraps a native slate paragraph representation, i.e. a Text node with spans
