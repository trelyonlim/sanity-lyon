...
function createBlockEditorOperations(blockEditor) {
  ...
  return {
    ...
    removeAnnotationFromSpan(spanNode, annotationType) {
      ...
      const data = _extends({}, spanNode.data.toObject(), {
    ...
    setBlockStyle(styleName) {
      ...
      state.blocks.forEach(blk => {
        const newData = _extends({}, blk.data.toObject(), { style: styleName });
    ...
    expandToFocusedWord(change) {
      ...
      const focusText = _change$state.focusText,
      ...
      const newEndOffset = charsBefore.size + (whiteSpaceAfterIndex > -1 ? whiteSpaceAfterIndex : charsAfter.size + 1);
