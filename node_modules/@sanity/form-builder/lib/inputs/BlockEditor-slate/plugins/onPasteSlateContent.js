...
function formBuilderNodeOnPaste(formBuilder, editorFields) {
  function processNode(node) {
    ...
    const newKey = (0, _randomKey2.default)(12);
  ...
  function onPaste(event, data, change) {
    ...
    const newNodesList = _slate.Block.createList(data.fragment.nodes.toArray().map(processNode));
    const newDoc = new _slate.Document({
