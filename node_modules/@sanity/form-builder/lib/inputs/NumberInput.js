...
class NumberInput extends _react2.default.Component /*:: <Props>*/ {
  constructor(...args) {
    var _temp;

    return _temp = super(...args), this.handleChange = (event /*: SyntheticEvent<HTMLInputElement>*/) => {
      const nextValue = event.currentTarget.value;
      this.props.onChange(_PatchEvent2.default.from(nextValue === '' ? (0, _PatchEvent.unset)() : (0, _PatchEvent.set)(Number(nextValue))));
    }, this.setInput = (input /*: ?TextInput*/) => {
      this._input = input;
    }, _temp;
  }
