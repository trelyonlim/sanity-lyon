...
function createUploadEvent(patches = []) /*: UploadEvent*/ {
  return {
    type: 'uploadEvent',
    patches
  };
...
const CLEANUP_EVENT = exports.CLEANUP_EVENT = createUploadEvent([UNSET_UPLOAD_PATCH]);
