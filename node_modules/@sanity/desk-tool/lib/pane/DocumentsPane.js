...
exports.default = (0, _router.withRouterHOC)((_temp = _class = class DocumentsPane extends _react2.default.PureComponent {
  ...
  isLiveEditEnabled() {
    const selectedSchemaType = _schema2.default.get(this.props.selectedType);
      ...
      _react2.default.createElement(
        ...
        ({ result, loading, error, onRetry, type }) => {
          if (error) {
            return _react2.default.createElement(
              _default6.default,
              { kind: 'danger', action: { title: 'Retry' }, onAction: onRetry },
              _react2.default.createElement(
                'div',
                null,
  ...
  published: _propTypes2.default.array,
  drafts: _propTypes2.default.array,
  onSetListLayout: _propTypes2.default.any,
  ...
  this.renderStatus = item => {
    ...
    return _react2.default.createElement(
      ...
      !isLiveEditEnabled && item.hasDraft && item.hasPublished && _react2.default.createElement(
        _reactTippy.Tooltip,
        {
  ...
  this.renderDocumentPaneItem = (item, index, options = {}) => {
    ...
    return _react2.default.createElement(
      _router.StateLink,
      { state: linkState, className: _DocumentsPane2.default.link, tabIndex: 0 },
      _react2.default.createElement(
        'div',
