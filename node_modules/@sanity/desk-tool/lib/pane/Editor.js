...
const getDiscardItem = (draft, published, isLiveEditEnabled) => isLiveEditEnabled ? null : {
  action: 'discard',
...
const getUnpublishItem = (draft, published, isLiveEditEnabled) => isLiveEditEnabled ? null : {
  action: 'unpublish',
  title: 'Unpublish…',
...
const getMenuItems = (draft, published, isLiveEditEnabled) => [getProductionPreviewItem, getDiscardItem, getUnpublishItem, getDuplicateItem, getDeleteItem, getInspectItem].map(fn => fn(draft, published, isLiveEditEnabled)).filter(Boolean);
...
exports.default = (0, _router.withRouterHOC)((_temp2 = _class = class Editor extends _react2.default.PureComponent {
  constructor(...args) {
    ...
    return _temp = super(...args), this.state = INITIAL_STATE, this.setSavingStatus = (0, _debounce3.default)(() => {
      ...
      const draft = _props6.draft,
            ...
            type = _props6.type,
            isReconnecting = _props6.isReconnecting;
      ...
      return _react2.default.createElement(
        ...
        showSavingStatus && _react2.default.createElement(
          ...
          _react2.default.createElement(
            'span',
            { className: _Editor2.default.syncSpinnerContainer },
            _react2.default.createElement(
              'span',
              { className: _Editor2.default.syncSpinner },
        ...
        isReconnecting && _react2.default.createElement(
          _reactTippy.Tooltip,
          {
            className: _Editor2.default.syncStatusReconnecting,
            arrow: true,
            theme: 'light',
            size: 'small',
            distance: '0',
        ...
        !this.isLiveEditEnabled() && _react2.default.createElement(
          _reactTippy.Tooltip,
          {
            arrow: true,
            theme: 'light',
  ...
  isLiveEditEnabled() {
    const selectedSchemaType = _schema2.default.get(this.props.type.name);
  ...
  render() {
    ...
    const draft = _props9.draft,
          ...
          isReconnecting = _props9.isReconnecting,
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: _Editor2.default.root },
        (isCreatingDraft || isPublishing || isUnpublishing) && _react2.default.createElement(
          'div',
          { className: _Editor2.default.spinnerContainer },
          isCreatingDraft && _react2.default.createElement(_spinner2.default, { center: true, message: 'Making changes\u2026' }),
          isPublishing && _react2.default.createElement(_spinner2.default, { center: true, message: 'Publishing\u2026' }),
          isUnpublishing && _react2.default.createElement(_spinner2.default, { center: true, message: 'Unpublishing\u2026' })
        ),
        _react2.default.createElement(
          'div',
        ...
        didPublish && _react2.default.createElement(
          _default8.default,
          { kind: 'success', timeout: 4 },
          _react2.default.createElement(_circleCheckIcon2.default, null),
          ' You just published',
          ' ',
          _react2.default.createElement(
            'em',
