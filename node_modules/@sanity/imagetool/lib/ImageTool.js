...
var _ImageTool = require('./styles/ImageTool.css');
...
function limitToBoundaries(value, delta) {
  var _value$crop = value.crop,
      top = _value$crop.top,
      right = _value$crop.right,
      bottom = _value$crop.bottom,
      left = _value$crop.left;
...
var getDevicePixelRatio = (0, _memoize3.default)(function () {
  var devicePixelRatio = window.devicePixelRatio || 1;
  var ctx = document.createElement('canvas').getContext('2d');
  var backingStoreRatio = (0, _getBackingStoreRatio2.default)(ctx) || 1;
  ...
  _createClass(ImageTool, [{
    ...
    value: function highlightCropHandles(context, opacity) {
      ...
      Object.keys(crophandles).forEach(function (handle) {
        context.fillStyle = _this2.state.cropping === handle ? 'rgba(202, 54, 53, ' + opacity + ')' : 'rgba(230, 230, 230, ' + (opacity + 0.4) + ')';
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: _ImageTool2.default.root },
        _react2.default.createElement(DragAwareCanvas, {
          className: _ImageTool2.default.canvas,
          readOnly: readOnly,
          ref: this.setCanvas,
