...
function resolveStyleImport(moduleId, opts) {
  ...
  const parts = (0, _resolver.resolveParts)({ basePath: opts.root, sync: true });
...
function getStyleResolver(opts) {
  return function resolveStyleProxy(moduleId, basedir, styleOptions) {
    return resolveStyleImport(moduleId, (0, _assign3.default)({ root: opts.from, basedir }, styleOptions));
  };
}