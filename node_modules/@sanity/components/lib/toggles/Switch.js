...
var _switchStyle = require('part:@sanity/components/toggles/switch-style');
...
class Switch extends _react2.default.Component {
  ...
  render() {
    ...
    const disabled = _props.disabled,
          ...
          rest = _objectWithoutProperties(_props, ['disabled', 'markers', 'checked', 'label', 'description', 'readOnly']);
