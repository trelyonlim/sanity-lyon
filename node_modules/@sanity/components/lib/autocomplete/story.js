...
var _default = require('part:@sanity/components/autocomplete/default');
...
}, { propTables: [_default2.default], role: 'part:@sanity/components/autocomplete/default' }).add('Default with suggestions',
// `
//   Default textfield
// `,
() => {
...
}, { propTables: [_default2.default], role: 'part:@sanity/components/autocomplete/default' });