...
(0, _storybook.storiesOf)('Labels').addDecorator(_knobs.withKnobs).add('Default', () => {
  return _react2.default.createElement(
    _sanity2.default,
    { part: 'part:@sanity/components/labels/default', propTables: [_default2.default] },
    _react2.default.createElement(
      _default2.default,
      { level: (0, _knobs.number)('level (prop)', 0), htmlFor: 'thisNeedsToBeUnique' },
      (0, _knobs.text)('children  (prop)', 'Label')
    )
  );
});