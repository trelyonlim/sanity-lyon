...
var _CurrentVersionsDialog = require('./CurrentVersionsDialog');

var _CurrentVersionsDialog2 = _interopRequireDefault(_CurrentVersionsDialog);
...
class UpdateNotifier extends _react.Component {
  ...
  render() {
    ...
    const Dialog = isUpToDate ? _CurrentVersionsDialog2.default : _UpdateNotifierDialog2.default;

    return _react2.default.createElement(
      'div',
      { className: _UpdateNotifier2.default.container },
      showUpdateNotifier && _react2.default.createElement(Dialog, { severity: severity, outdated: outdated, onClose: this.handleHideUpdateNotifier }),
      _react2.default.createElement(
        'button',
        { type: 'button', onClick: this.handleShowUpdateNotifier, className: className },
        ...
        _react2.default.createElement(
          'div',
          { className: isUpToDate ? _UpdateNotifier2.default.upToDateText : _UpdateNotifier2.default.upgradeText },
