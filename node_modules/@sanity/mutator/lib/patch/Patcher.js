...
class Patcher {
  ...
  apply(value /*: Object*/) {
    ...
    const accessor = new _ImmutableAccessor2.default(value);
  ...
  applyViaAccessor(accessor /*: Object*/) {
    ...
    this.patches.forEach(patch => {
      ...
      const matcher = _jsonpath.Matcher.fromPath(patch.path).setPayload(patch);
...
exports.default = Patcher; // Recursively (depth first) follows any leads generated by the matcher, expecting
