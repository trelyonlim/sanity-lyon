...
var _SquashingBuffer = require('./SquashingBuffer');
...
class Commit {
  ...
  squash(doc /*: Object*/) {
    const result = _Mutation2.default.squash(doc, this.mutations);
...
class BufferedDocument {
  ...
  rebase() {
    ...
    const changed = !(0, _isEqual3.default)(this.LOCAL, oldLocal);
