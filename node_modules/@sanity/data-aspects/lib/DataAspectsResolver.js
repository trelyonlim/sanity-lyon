...
function warnAboutHiddenTypes() {
  ...
  console.warn("👋 Hi there! Looks like you have hidden types configured in your studio's config/@sanity/data-aspects.json" + ` This config is now obsolete and should be removed. Read more at ${(0, _generateHelpUrl2.default)('toplevel-objects-to-document-type')}`);
}
