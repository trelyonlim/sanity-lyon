...
var _padEnd2 = require('lodash/padEnd');

var _padEnd3 = _interopRequireDefault(_padEnd2);
...
function generateCommandsDocumentation(commandGroups, group = 'default') {
  ...
  const rows = ['usage: sanity [-v|--version] [-d|--debug] [-h|--help] <command> [<args>]', '', 'Commands:'].concat(commandGroup.map(cmd => `   ${(0, _padEnd3.default)(cmd.name, cmdLength)} ${cmd.description}`)).concat(['', "See 'sanity help <command>' for specific information on a subcommand."]);
