...
const rimraf = (0, _es6Promisify.promisify)(_rimraf2.default);
...
exports.default = (() => {
  var _ref = _asyncToGenerator(function* (args, context) {
    ...
    const flags = Object.assign({ minify: true, profile: false, stats: false, 'source-maps': false }, args.extOptions);
    ...
    yield (0, _reinitializePluginConfigs.tryInitializePluginConfigs)({ workDir, output });
    ...
    try {
      ...
      const doc = yield (0, _server.getDocumentElement)(_extends({}, compilationConfig, { hashes: chunkMap }), {
