...
const serverConnection = {
  ...
  query(query, params) {
    return _observable2.default.from(_client2.default.observable.listen(query, params || {}, {
      includeResult: false,
  ...
  mutate(mutations) {
    return _observable2.default.from(_client2.default.observable.dataRequest('mutate', mutations, {
      visibility: 'async',
