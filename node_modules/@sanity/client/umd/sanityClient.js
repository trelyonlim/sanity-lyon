...
"use strict";function parseEvent(e){try{var r=e.data&&JSON.parse(e.data)||{};return assign({type:e.type},r)}catch(e){return e}}function cooerceError(e){if(e instanceof Error)return e;var r=parseEvent(e);return r instanceof Error?r:new Error(extractErrorMessage(r))}function extractErrorMessage(e){return e.error?e.error.description?e.error.description:"string"==typeof e.error?e.error:JSON.stringify(e.error,null,2):e.message||"Unknown listener error"}var assign=require("object-assign"),Observable=require("@sanity/observable/minimal"),polyfilledEventSource=require("@sanity/eventsource"),pick=require("../util/pick"),defaults=require("../util/defaults"),encodeQueryString=require("./encodeQueryString"),EventSource="undefined"!=typeof window&&window.EventSource?window.EventSource:polyfilledEventSource,possibleOptions=["includePreviousRevision","includeResult"],defaultOptions={includeResult:!0};module.exports=function(e,r){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},t=defaults(n,defaultOptions),o=pick(t,possibleOptions),i=encodeQueryString({query:e,params:r,options:o}),s=this.clientConfig,u=s.url,c=s.token,a=s.withCredentials,d=""+u+this.getDataUrl("listen",i),l=t.events?t.events:["mutation"],v=-1!==l.indexOf("reconnect"),f={};return(c||a)&&(f.withCredentials=!0),c&&(f.headers={Authorization:"Bearer "+c}),new Observable(function(e){function r(){y||(s(),y||E.readyState===EventSource.CLOSED&&(i(),clearTimeout(p),p=setTimeout(c,100)))}function n(r){e.error(cooerceError(r))}function t(r){var n=parseEvent(r);return n instanceof Error?e.error(n):e.next(n)}function o(r){y=!0,i(),e.complete()}function i(){E.removeEventListener("error",r,!1),E.removeEventListener("channelError",n,!1),E.removeEventListener("disconnect",o,!1),l.forEach(function(e){return E.removeEventListener(e,t,!1)}),E.close()}function s(){v&&e.next({type:"reconnect"})}function u(){var e=new EventSource(d,f);return e.addEventListener("error",r,!1),e.addEventListener("channelError",n,!1),e.addEventListener("disconnect",o,!1),l.forEach(function(r){return e.addEventListener(r,t,!1)}),e}function c(){E=u()}function a(){y=!0,i()}var E=u(),p=void 0,y=!1;return a})};
